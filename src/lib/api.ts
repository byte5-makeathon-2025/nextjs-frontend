import type { AuthResponse, LoginRequest, RegisterRequest, Wish, CreateWishRequest, UpdateWishRequest, User } from "@/types";

const API_BASE_URL = "https://byte5-makeathon-backend-feat-team-b-e3zb5y.laravel.cloud/api";
